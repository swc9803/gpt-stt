...
function buildGptSttPrompt(message: string) {
	return [
		...
		"항상 정중한 존댓말로 답한다.",
		"평소 답변은 쉽고 간결하게 하되, 사용자가 정보나 가격을 물으면 너무 짧게 끝내지 않는다.",
		"사용자가 자세히 알려 달라고 하면 이전 답변을 반복하지 말고 필요한 재료, 순서, 주의점을 더 구체적으로 알려준다.",
		...
		"상품이나 가격 질문은 대략적인 가격대, 가격이 달라지는 기준, 구매/확인 링크를 함께 준다.",
